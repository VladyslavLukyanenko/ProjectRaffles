...
namespace ProjectIndustries.ProjectRaffles.Core.Modules.WestUpNyc
{
  ...
  public class WestUpNyc : EmailBasedRaffleModuleBase<IWestUpNycClient>
  {
    ...
    public WestUpNyc(IWestUpNycClient client)
      : base(client, @"https:\/\/www\.westnyc\.com\/pages\/.*")
    {
    }
