...
namespace ProjectIndustries.ProjectRaffles.Core.Modules.DoverStreetMarketLondonInstoreModule
{
  ...
  public class DoverStreetMarketLondonInstore : EmailBasedRaffleModuleBase<IDoverStreetMarketLondonInstoreClient>
  {
    ...
    public DoverStreetMarketLondonInstore(IDoverStreetMarketLondonInstoreClient client, ICaptchaSolveService captchaSolver)
    ...
    protected override async Task<bool> ExecuteAsync(CancellationToken ct)
    {
      ...
      var payload = new DoverStreetMarketLondonInstorePayload(_addressFields, parseRaffle, EmailField, captcha, _sizeValue.Value, _questionAnswer.Value);
