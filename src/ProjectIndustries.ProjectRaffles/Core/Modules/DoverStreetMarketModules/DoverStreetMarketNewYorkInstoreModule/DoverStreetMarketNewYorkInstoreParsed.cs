...
{
    public class DoverStreetMarketNewYorkInstoreParsed
    {
        public DoverStreetMarketNewYorkInstoreParsed()
        {
        }
        
        public DoverStreetMarketNewYorkInstoreParsed(string formkey, string viewkey, string viewparam, string fullNameField, string emailField, string phoneNumberField,
            string sizeField, string billingField, string zipcodeField, string mailinglist, string questionField)
        {
            Form = formkey;
            Viewkey = viewkey;
            Viewparam = viewparam;
