...
{
  public class PanthersAccountGeneratorsParsed
  {
    public PanthersAccountGeneratorsParsed()
    {
    }

    public PanthersAccountGeneratorsParsed(Dictionary<string, string> countryDictionary,
