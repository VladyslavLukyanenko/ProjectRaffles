...
{
    public class MahaAccountGeneratorClient : IMahaAccountGeneratorClient
    {
      ...
      public MahaAccountGeneratorClient(IHttpClientBuilder builder, IPhoneCodeService phoneCodeService)
      { 
          _builder = builder;
      ...
      public async Task<MahaAccountGeneratorParsed> GetCountriesAsync(CancellationToken ct)
      {
        var url = "https://shop.maha-amsterdam.com/us/account/register/";
       ...
       foreach (var countryObject in parsedJson)
        ...
        return new MahaAccountGeneratorParsed(countryDictionary, hasRegionsDictionary, countryType);
      }

     public async Task<string> GetCountryRegionIdAsync(string country, string province, CancellationToken ct)
     {
         var regionUrl = $"https://shop.maha-amsterdam.com/us/services/regions/?country={country}";
     ...
     public async Task<string> SubmitAccountAsync(AddressFields addressFields, string email, string type,
      ...
      { 
          ...
          var content = new FormUrlEncodedContent(new Dictionary<string, string>
          {
              ...
              {"phone", ""},
              {"mobile", addressFields.PhoneNumber},
              {"birthdate_d", ""},
              {"birthdate_m", ""},
              {"birthdate_y", ""},
              {"format", type},
          ...
          _httpClient.DefaultRequestHeaders.Add("origin","https://shop.maha-amsterdam.com");
          _httpClient.DefaultRequestHeaders.Add("referer","https://shop.maha-amsterdam.com/us/account/register/");
          var endpoint = "https://shop.maha-amsterdam.com/us/account/registerPost/";
      ...
      public async Task<bool> SubmitCaptchaAsync(string authtoken, string captcha, CancellationToken ct)
      {
          ...
          _httpClient.DefaultRequestHeaders.Add("referer","https://shop.maha-amsterdam.com/us/services/challenge/");
          var endpoint = "https://shop.maha-amsterdam.com/us/account/registerPost/";
