...
namespace ProjectIndustries.ProjectRaffles.WpfUI.MapBox.MapboxNetCore
{
    public static class Core
    {
        ...
        {
            return GetEmbeddedResource(typeof(Core), typeof(Core).Namespace + "." + name);
        }
        ...
        {
            var mainScript = getEmbeddedResource("web.frame.html");
            var glScript = getEmbeddedResource("web.bundle.min.js");
